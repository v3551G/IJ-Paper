...
\begin{document}
	...
	\begin{frontmatter}
		...
		\title{Sparse and Robust Least Squares Support Vector Machines for Classification}
...
%	\newpage
	...
	\begin{enumerate}
		...
		%\item definieer een $h$ subset als een set van $h$ observaties
		\item definieer R1 en R2 als de reguliere observatie lijst van B1 en B2 respectively.
		%\item definieer ROI1, ROI2 als de ... volgens de roi?
