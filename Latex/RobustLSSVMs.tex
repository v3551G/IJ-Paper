...
%	\subsection{}
	...
	[EXPLICIET VERWIJZEN NAAR FIGUUR OP DE VOLGENDE BLZ IN DE UITLEG uitleggen waarom het teken van alpha zin heeft ] \\
...
\hat{\mathbf{y}} = \mathrm{sign}(K_l\mathbf{\beta}_l + K_{nl}\beta_{nl}  + b \mathbf{1}),
	...
	\begin{figure}[!htb]
		...
		\begin{subfigure}[b]{0.40\linewidth}
			...
			\caption{\label{fig:spatialmedc2}}
		\end{subfigure} 
		\caption{Uiteindelijke oplossing na information transfer, waarbij de info van de reguliere observaties getransfereerd is naar de support vectors, weergegeven als 'd'. Ter vergelijking tonen we de de naive LS-SVM figuren c, d. De impact van de outliers op het LS-SVM hypervlak is duidelijk zichtbaar, in vergelijking met the proposed.}
		\label{fig:results}
	\end{figure}
