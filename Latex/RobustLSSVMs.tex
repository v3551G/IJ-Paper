...
To use C-steps in kernel feature space  $\mathcal{H}$, we integrate the mapping function $\phi(.)$ in the required formula's, as follows: 
\begin{equation}
	\label{eq:center}
