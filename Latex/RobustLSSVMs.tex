...
\begin{figure}[!htb]
	...
	\caption{Figure \subref{fig:dmodel} illustreerd een normaal gedistribueerd classificatieprobleem (blauw, groen), waarbij beiden klassen disjuncte outliers bevatten uit eenzelfde materiaal groep, hier weergegeven in het rood. Na opsplitsen van dataset volgens hun class label [STAP2?] worden de $h_init$ dichtste punten bij de spatiale mediaan gebruikt als initiele subset voor het C-step algoritme, weergeven in het groen voor beiden classen in figuur b, c respectively. }
\end{figure}
