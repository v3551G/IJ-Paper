...
%	\end{enumerate} 
	...
	%\newpage
	\subsubsection{Outlier detection in kernel feature space}
	...
	\begin{itemize}
		...
		\begin{equation}
			w(d^2) = \mathbf{1}_{(d^2 \le c)} + \mathbf{0}_{(d^2 > c)}
		\end{equation}
		Here, $c$ is a threshold which we choose here as $c = max(\chi_p^2(0.975), max(d_h^2) )$, with $d_h^2$ the distance vector of the observations in the $h$-subset. 
%		\begin{equation}
%		w_i =
%		\begin{cases}
...
%		\end{equation}
	...
	Finally, the weights $w$ are then used to train a weighted classifier model, as follows:
	
	\begin{equation}
		\begin{bmatrix}
		0 & \mathbf{y}_w^T \\
		\mathbf{y_w} & \Omega + \gamma^{-1} \mathbf{w}
		\end{bmatrix}	
		\begin{bmatrix}
		b \\
		\alpha
		...
		\end{bmatrix},
	\end{equation}
	Here $\mathbf{y_w}  = \mathbf{y} \circ \mathbf{w}$ denotes the element-wise product of the class labels with the weight vector. The algorithm workings are visualised in Figure \ref{fig:C-step}, where it can be seen that the initial estimate converges to the outlier free dataset.
...
%		\begin{subfigure}[b]{0.40\linewidth}
%			\centering\includegraphics[width=1\linewidth]{figures/landmarks/Lin_model.pdf}
%			\caption{\label{fig:spatialmedc1}}
%		\end{subfigure}
%		\begin{subfigure}[b]{0.40\linewidth}
%			\centering\includegraphics[width=1\linewidth]{figures/landmarks/nonLin_model.pdf}
%			\caption{\label{fig:spatialmedc2}}
%		\end{subfigure} \\
		
		\begin{subfigure}[b]{0.40\linewidth}
			\centering\includegraphics[width=1\linewidth]{figures/landmarks/Lin_roi1.pdf}
			\caption{\label{fig:dmodel1}} 
		\end{subfigure}
		\begin{subfigure}[b]{0.40\linewidth}
			\centering\includegraphics[width=1\linewidth]{figures/landmarks/nonLin_roi1.pdf}
			\caption{\label{fig:dmodel2}} 
		\end{subfigure} \\
	
		\begin{subfigure}[b]{0.40\linewidth}
			\centering\includegraphics[width=1\linewidth]{figures/landmarks/Lin_roi2.pdf}
			\caption{\label{fig:dmodel1}} 
		\end{subfigure}
		\begin{subfigure}[b]{0.40\linewidth}
			\centering\includegraphics[width=1\linewidth]{figures/landmarks/nonLin_roi2.pdf}
			\caption{\label{fig:dmodel2}} 
		\end{subfigure} \\
	
		
		\begin{subfigure}[b]{0.40\linewidth}
			\centering\includegraphics[width=1\linewidth]{figures/landmarks/Lin_landmarks.pdf}
			\caption{\label{fig:kcstepc1}}
		\end{subfigure}
		\begin{subfigure}[b]{0.40\linewidth}
			\centering\includegraphics[width=1\linewidth]{figures/landmarks/nonLin_landmarks.pdf}
			\caption{\label{fig:kcstepc2}}
		\end{subfigure}
		\caption{....}
		\label{fig:C-step}
