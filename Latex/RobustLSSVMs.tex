...
$ \tilde{K}^{(h)} \in \mathbb{R}^{N \times h}$ and $1'_h \in \mathbb{R}^{N \times h}$ with all entries $\frac{1}{h}$
\begin{equation}
\tilde{K}^{(h)} = K^{(h)} - 1'_h K^{(hh)} - K^{(h)}1_h + 1'_h K^{(hh)}1_h
\end{equation}
...
$ \tilde{K}^{(hh)} \in \mathbb{R}^{h \times h}$ and $1_h \in \mathbb{R}^{h \times h}$ with all entries $\frac{1}{h}$
\begin{align}
\label{eq:centerKh}
...
\end{align}
Where the centring of the kernel matrix of $n$ observations, given the $h$-subset follows the similar derivation. Define the kernel matrix $ \tilde{K}^{(h)} \in \mathbb{R}^{N \times h}$ and $1'_h \in \mathbb{R}^{N \times h}$ with all entries $\frac{1}{h}$
